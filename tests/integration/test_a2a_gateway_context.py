...
class TestA2AGatewayContextIdWithPlatform:
    ...
    async def test_different_contexts_create_separate_rooms_with_isolated_messages(
        ...
        msg_a_response = await api_client.agent_api_messages.create_agent_chat_message(
            room_a,
            message=ChatMessageRequest(
        ...
        msg_b_response = await api_client.agent_api_messages.create_agent_chat_message(
            room_b,
            message=ChatMessageRequest(
        ...
        context_a_response = await api_client.agent_api_context.get_agent_chat_context(
            room_a
        )
        ...
        context_b_response = await api_client.agent_api_context.get_agent_chat_context(
            room_b
        )
