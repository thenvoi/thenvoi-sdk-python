...
Run with (from repo root):
    uv run examples/langgraph/scenarios/06_delegate_to_sql_agent.py

Note: Must be run from repo as it imports standalone/sql_agent.py
"""
...
from examples.langgraph.standalone.sql_agent import (
    create_sql_agent,
    download_chinook_db,
)
