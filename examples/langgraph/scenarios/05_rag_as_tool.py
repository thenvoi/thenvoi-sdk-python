...
Run with (from repo root):
    uv run examples/langgraph/scenarios/05_rag_as_tool.py

Note: Must be run from repo as it imports standalone/rag.py
"""
...
from examples.langgraph.standalone.rag import create_rag_graph
