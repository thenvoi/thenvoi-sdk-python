...
4. ACP integration: Editor-facing server and subprocess client adapters
...
├── integrations/   # Deep integrations (ACP, MCP, Parlant)
│   └── acp/        # ACP server + client adapters, router, push handler
